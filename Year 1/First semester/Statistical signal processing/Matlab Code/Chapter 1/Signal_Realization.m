...
N=20;         % Numero di campioni prelevati
upsampl=25;   % fattore di sovracampionamento per simulare il "tempo continuo"
...
xlabel('Time (t) [msec]')               
ylabel('Y(t)')
title('Constant signal in AWGN of bandwidth B=1/2T_{c}: Y(t)=S+W(t)')
legend('Observed signal Y(t)','Signal samples Y(nT_{c})','Constant signal S')
